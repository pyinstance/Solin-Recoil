...
namespace UniCoil {
    ...
    void Launcher::Draw()
    {
        ...
        if (!ImGui::Begin("Solin - No Recoil", (bool*)&g_Running, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_AlwaysAutoResize)) {
            ImGui::PopStyleColor();
            ImGui::PopStyleColor();
            ImGui::PopStyleColor();
            ImGui::End();
    ...
    void Launcher::Menu()
    {
        ...
        //  EXIT
        if (ImGui::Button("EXIT | Dev config", ImVec2(ImGui::GetWindowContentRegionWidth(), BUTTONS[1]))) g_Running = FALSE;
    }
    ...
    void Launcher::InitStyle()
    {
        ...
        //	COLORS
        colors[ImGuiCol_Text] = ImVec4(0.6157767772674561f, 0.2998582422733307f, 0.9570815563201904f, 1.0f);
